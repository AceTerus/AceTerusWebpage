...
import { EventNotificationsProvider } from "./events/context/EventNotificationsContext";
import { EventsNavbar } from "./events/components/EventsNavbar";
import { useEventReminders } from "./events/hooks/useEventReminders";
...
// Runs reminder check inside the provider tree
const EventsContent = () => {
  useEventReminders();
  return (
